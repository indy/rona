...
static Dim2 g_sprite_locations[] = {
  [0].row = 2, [0].col = 0, // TS_Blank

  [1].row = 1, [1].col = 25, //   TS_Floor01
  [2].row = 1, [2].col = 26, //   TS_Floor02
  [3].row = 1, [3].col = 27, //   TS_Floor03
  [4].row = 1, [4].col = 28, //   TS_Floor04
  [5].row = 1, [5].col = 29, //   TS_Floor05
  [6].row = 2, [6].col = 25, //   TS_WallBottom
  [7].row = 2, [7].col = 26, //   TS_WallTop
  [8].row = 2, [8].col = 27, //   TS_WallLeft
  [9].row = 2, [9].col = 28, //   TS_WallRight
  [10].row = 2, [10].col = 29, //   TS_CornerA_TL
  [11].row = 2, [11].col = 30, //   TS_CornerA_TR
  [12].row = 2, [12].col = 31, //   TS_CornerA_BL
  [13].row = 2, [13].col = 32, //   TS_CornerA_BR
  [14].row = 2, [14].col = 33, //   TS_CornerB_TL
  [15].row = 2, [15].col = 34, //   TS_CornerB_TR
  [16].row = 2, [16].col = 35, //   TS_CornerB_BL
  [17].row = 2, [17].col = 36, //   TS_CornerB_BR

  [18].row = 9, [18].col = 1,  //   TS_Hero
  [19].row = 4, [19].col = 0,  //   TS_Block
  [20].row = 8, [20].col = 1,  //   TS_DoorClosed
  [21].row = 5, [21].col = 0,  //   TS_PressurePadActivated
  [22].row = 5, [22].col = 0,  //   TS_Warning
  [23].row = 5, [23].col = 0  //   TS_Debug4Corners
